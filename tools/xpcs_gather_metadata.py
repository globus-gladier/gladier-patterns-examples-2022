...
def gather_xpcs_metadata(**data):
    ...
    try:
        ...
        root_folder = pathlib.Path(
            metadata["measurement.instrument.acquisition.root_folder"]
        )
        # Cycle: 2021-1
...
class GatherXPCSMetadata(GladierBaseTool):
    ...
    funcx_functions = [gather_xpcs_metadata]
...
if __name__ == "__main__":
    data = {
        ...
        "boost_corr": {"gpu_flag": 0},
        "pilot": {"metadata": {}, "groups": []},
    }
